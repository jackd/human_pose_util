...
from human_pose_util.dataset.eva.meta import eval_subjects, eval_base_sequences, cameras
from human_pose_util.dataset.eva.hdf5_tree import data_file, data_file_exists, RootNode, convert
    ...
    for subject in eval_subjects:
        for base_sequence in eval_base_sequences:
            for camera in cameras:
                for run in ['1', '3']:
                    yield '_'.join(
                        [subject, base_sequence, run, camera, _ModeKeys.train])
